...
Here we only list a few representative works. Kumar \textit{et al}.~\shortcite{Kumar1999} describe material composition by dividing a volume into sub-volumes. They perform material interpolation  using local, sub-volume coordinate systems. 
