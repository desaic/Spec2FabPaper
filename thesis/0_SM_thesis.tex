...
% \setcounter{page}{1}
\include{chap1}
%\include{chap2} % chap2.tex should be in the same directory in this case
...
%\bibliography{bibliography} % use with BibTeX (bibliography.bib should be in the same directory in this case)
