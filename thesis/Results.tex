...
We have replicated the subsurface scattering process of Ha\v{s}an et al.~\shortcite{Hasan:2010:PRO} using our framework (Figure~\ref{fig:sub}).
...
%We note that the ability to reuse Reducer Nodes simplifies the configuration of new processes.
...
\chapter{Discussion}
\biglet{T}{hrough} our series of experiments, the \emph{reducer tree} and \emph{tuner network} have allowed us to reuse a large number of software components.
