   ...
   \begin{subfigure}[b]{0.2\textwidth}
	\centering
    	...
    	\includegraphics[width=\textwidth]{figure/caustics.png}
                ...
                \label{teaser:objet}
        \end{subfigure}
        \caption{Various effects printed with a 3D printer.
...
over the volume, running simulation with the new material assignment
and computing errors given the simulated result.
We note that gradient computation of our material function $\lambda$ can be performed by efficiently traversing the Reducer Network.
