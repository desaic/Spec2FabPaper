...
The sample Reducer Network can be constructed with the following pseudo-code.
...
\section{Results}
We used various Reducer Nodes , simulation code and optimization algorithms in our experiments.
A summary is listed in Table~\ref{tab:built-in}
\begin{table}
\centering %why
...
\hline 
Geometry Node & optics & \multirow{4}{*}{Error Diffusion, SPSA}\\
 InputMesh, Stratum, Column&\\ \cline{1-2}
Material Node & deformation  \\
Constant, Layered,
QuadLayer, SubdivisionSufrace& \\
\hline 
\end{tabular}
