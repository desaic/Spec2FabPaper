...
We als considered one additional property:mass. In this example, we
tried to make the material as light as possible.
\section{Caustics for a Mesh}
...
and we use a generic rendering package (NVidia optiX). Our algorithm took 6 hours to finish
